...
export default function Signup() {
  const [isWeb3Signup, setIsWeb3Signup] = useState(false);
  ...
  return (
    <Layout
      title="Sign Up | Zyptal"
      description="Create a new Zyptal account">
      <div className={styles.authContainer}>
        <div className={styles.authCard}>
          <div className={styles.authHeader}>
            <h1>Create a Zyptal Account</h1>
            <p>Get started with our data extraction API</p>
          </div>

          <div className={styles.authTabs}>
            <button 
              className={`${styles.authTab} ${!isWeb3Signup ? styles.authTabActive : ''}`}
              onClick={() => setIsWeb3Signup(false)}>
              Email Signup
            </button>
            <button 
              className={`${styles.authTab} ${isWeb3Signup ? styles.authTabActive : ''}`}
              onClick={() => setIsWeb3Signup(true)}>
              Web3 Signup
            </button>
          </div>
          ...
          {!isWeb3Signup ? (
            <form className={styles.authForm} onSubmit={handleTraditionalSignup}>
            ...
            <div className={styles.web3Container}>
              <div className={styles.walletInfo}>
                ...
                <p>Connect your Web3 wallet to create an account securely without a password</p>
              </div>
              
              <div className={styles.formGroup}>
                <label htmlFor="web3Email">Email Address (Optional)</label>
                <input
                  type="email"
                  id="web3Email"
                  value={email}
                  ...
                  placeholder="your@email.com"
                />
                <small>For notifications and updates</small>
              </div>
              ...
              <button 
                ...
                disabled={isLoading}>
                {isLoading ? 'Connecting...' : 'Connect Wallet to Sign Up'}
              </button>
