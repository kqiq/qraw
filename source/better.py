...
#         # Initialize display if headless
#         if self.headless:
...
class SPATextExtractor:
    ...
    def _extract_text(self, driver: ChromiumPage, url: str) -> Dict:
        ...
        # Scroll-based content triggering using DrissionPage's methods
        for _ in range(self.scroll_attempts):
            # Use run_js instead of execute_script
